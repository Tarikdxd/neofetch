...
#    Neofetch is simple system cleaner script - neofetch
#    Copyright (C) 2024  tarikdxd
#
...
# Special tahnks to Kanser Society.
...
ghost:banner() {
    echo -e "${green} K A N S E R S O C I E T Y${Bcyan}
...
${Bwhite}exit${reset}\t${red}exit${reset} the interactive ${Bwhite}shell${reset}."
                ;;
                version|versiyon)
                    echo -e "Developed by ${green}tarikdxd${reset} ${Bwhite}${0##*/}${reset}, version ${Bcyan}${version}${reset}."
                ;;
                exit|quit|cikis)
                    exit 0
                ;;
